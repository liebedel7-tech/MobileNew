...
export const INITIAL_CONSUMERS: DistrictConsumer[] = [
  ...
  },
  {
    ...
    meterNumber: 'TAG-01048',
    meterSize: '1/2"',
    category: 'Residential',
    status: 'Disconnected',
    previousReading: 410,
    previousReadingDate: '2026-07-10',
    previousConsumption: 16,
  ...
  },
  {
    ...
    meterNumber: 'TAG-01049',
    meterSize: '1/2"',
    category: 'Residential',
    status: 'Active',
    previousReading: 680,
    previousReadingDate: '2026-07-14',
    previousConsumption: 24,
  ...
  },
  {
    ...
    meterNumber: 'TAG-01051',
    meterSize: '3/4"',
    category: 'Commercial B',
    status: 'Active',
    previousReading: 914,
    previousReadingDate: '2026-07-14',
    previousConsumption: 48,
...
export const INITIAL_READERS: DistrictReader[] = [
  ...
  },
  {
    ...
    assignedRoutes: ['Natumolan', 'Sta. Cruz'],
    status: 'pending',
